...
namespace Univercity.Data
{
    public class DbInitializer
    {
        public static void Initialize(LessonsDbContext db)
        {
            ...
            {
                db.StudentsGroups.Add(new StudentsGroup { NumberOfGroup = studentGroupID.ToString(), QuantityOfStudents = random.Next(15,31), FacilityId = random.Next(1, (facilities_voc.Length+1)) });
            }
            //db.SaveChanges();
